...
$sql0 = "SELECT * FROM produtos WHERE produtoId = ".$produtoid."";
$result0 = $conn->query($sql0);
if($result0->num_rows > 0){
    $row0 = $result0->fetch_assoc();
    unlink($target_dir.$row0["imagem1"]);
    unlink($target_dir.$row0["imagem2"]);
    unlink($target_dir.$row0["imagem3"]);
    unlink($target_dir.$row0["imagem4"]);
}
...
if (isset($cadastrar)) {
    ...
    $sql = "UPDATE produtos
            SET nome = '".$nome."', preco = '".$preco."', descricaoSimples = '".$descSim."', descricaoCompleta = '".$descCom."', categoria = '".$categoria."', subcategoria = '".$subcategoria."', peso = '".$peso."', altura = '".$altura."', largura = '".$largura."', comprimento = '".$comprimento."', imagem1 = '".$name1."', imagem2 = '".$name2."', imagem3 = '".$name3."', imagem4 = '".$name4."'
            WHERE produtoId = ".$_POST["inputId"].";";
