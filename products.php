...
<!---->
		<div class="product">
		 ...
		 <ul class="menu">
		<li class="item1"><a href="#">Categoria 1 </a>
			<ul class="cute">
				<li class="subitem1"><a href="single.html">Sub Categoria </a></li>
				<li class="subitem2"><a href="single.html">Sub Categoria </a></li>
				<li class="subitem3"><a href="single.html">Sub Categoria </a></li>
			</ul>
		</li>
		<li class="item2"><a href="#">Categoria 2 </a>
			<ul class="cute">
				<li class="subitem1"><a href="single.html">Sub Categoria </a></li>
				<li class="subitem2"><a href="single.html">Sub Categoria </a></li>
				<li class="subitem3"><a href="single.html">Sub Categoria </a></li>
		...
		<li class="item3"><a href="#">Categoria 3</a>
			<ul class="cute">
				<li class="subitem1"><a href="single.html">Sub Categoria </a></li>
				<li class="subitem2"><a href="single.html">Sub Categoria </a></li>
				<li class="subitem3"><a href="single.html">Sub Categoria </a></li>
		...
		<li class="item4"><a href="#">Categoria 4</a>
			<ul class="cute">
				<li class="subitem1"><a href="single.html">Sub Categoria </a></li>
				<li class="subitem2"><a href="single.html">Sub Categoria </a></li>
				<li class="subitem3"><a href="single.html">Sub Categoria </a></li>
		...
		<li class="item4"><a href="#">Categoria 5</a>
			<ul class="cute">
				<li class="subitem1"><a href="product.html">Sub Categoria </a></li>
				<li class="subitem2"><a href="product.html">Sub Categoria </a></li>
				<li class="subitem3"><a href="product.html">Sub Categoria </a></li>
			</ul>
		</li>
	</ul>
					</div>
				...
				<?php
					...
					if ($result->num_rows > 0) {
						...
						while($row = $result->fetch_assoc()) {
							...
							<a  href=\"\" class=\"item_add\" id=\"addToCart\" data-id=\"" . $row["produtoId"]. "\" data-name=\"" . $row["nome"]."\" data-price=\"" . $row["preco"]. "\" data-description=\"" . $row["descricaoSimples"]."\"><p class=\"number item_price\"><i> </i>R$". $row["preco"]. "</p></a>						
							</div>";
							$count = $count+1;
						if( $count % 3 == 0 ){
